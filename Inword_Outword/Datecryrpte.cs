...
namespace Inword_Outword {
    ...
    public class Datecryrpte : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Inword_Outword.Datecryrpte.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDatecryrpte : Component, ICachedReport {
        
        public CachedDatecryrpte() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Datecryrpte rpt = new Datecryrpte();
            rpt.Site = this.Site;
            return rpt;
        }
