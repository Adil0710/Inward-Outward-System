...
namespace Inword_Outword
{
    public partial class Inward : Form
    {
        ...
        private void Inward_Load(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection("Data source=DESKTOP-JCU5309\\SQLEXPRESS;Initial catalog=akimss;integrated security=true");
            ...
            SqlConnection con = new SqlConnection("Data source=DESKTOP-JCU5309\\SQLEXPRESS;Initial catalog=akimss;integrated security=true");
